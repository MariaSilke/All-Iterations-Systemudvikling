...
CREATE TABLE `restrictions` (
  ...
  `assamblyBan` varchar(50) DEFAULT NULL,
  `maskRecommendation` varchar(50) DEFAULT NULL,
  `closureProfessions` varchar(50) DEFAULT NULL,
  `testRecommendations` varchar(50) DEFAULT NULL
